...
public class ErrorController {
    ...
    @Autowired
    public ErrorController(LocationRepository locationRepository, FreeTimeActionRepository freeTimeActionRepository, HobbyRepository hobbyRepository, PersonRepository personRepository) {
